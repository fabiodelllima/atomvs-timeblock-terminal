...
def test_describe_filter_with_month():
    ...
    desc = _describe_filter(
        weeks=2, all_events=False, limit=None, month="+1", week=None, day=None
    )
...
def test_describe_filter_with_week():
    ...
    desc = _describe_filter(
        weeks=2, all_events=False, limit=None, month=None, week="0", day=None
    )
...
def test_describe_filter_with_day():
    ...
    desc = _describe_filter(
        weeks=2, all_events=False, limit=None, month=None, week=None, day="+1"
    )
...
def test_describe_filter_with_weeks():
    ...
    desc = _describe_filter(
        weeks=4, all_events=False, limit=None, month=None, week=None, day=None
    )
...
def test_describe_filter_with_limit():
    ...
    desc = _describe_filter(
        weeks=2, all_events=False, limit=10, month=None, week=None, day=None
    )
...
def test_describe_filter_with_all_events():
    ...
    desc = _describe_filter(
        weeks=2, all_events=True, limit=None, month=None, week=None, day=None
    )
    assert desc == ""
