...
class TestAddErrors:
    ...
    def test_add_invalid_time_format(self, isolated_db, cli_runner):
    ...
    def test_add_start_after_end_valid_crossing_midnight(self, isolated_db, cli_runner):
    ...
    def test_add_invalid_hex_color_format(self, isolated_db, cli_runner):
    ...
    def test_add_invalid_hex_color_length(self, isolated_db, cli_runner):
