...
class TestBRHabitInstance001:
    ...
    def test_br_habitinstance_001_pending_to_done(self):
    ...
    def test_br_habitinstance_001_pending_to_not_done_skip(self):
    ...
    def test_br_habitinstance_001_pending_to_not_done_timeout(self):
    ...
    def test_br_habitinstance_001_done_is_final(self):
    ...
    def test_br_habitinstance_001_not_done_is_final(self):
...
class TestBRHabitInstance002:
    ...
    def test_br_habitinstance_002_done_requires_done_substatus(self):
    ...
    def test_br_habitinstance_002_not_done_requires_not_done_substatus(self):
    ...
    def test_br_habitinstance_002_pending_no_substatus(self):
    ...
    def test_br_habitinstance_002_substatus_mutually_exclusive(self):
...
class TestBRHabitInstance003:
    ...
    def test_br_habitinstance_003_excessive_over_150(self):
    ...
    def test_br_habitinstance_003_overdone_110_150(self):
    ...
    def test_br_habitinstance_003_full_90_110(self):
    ...
    def test_br_habitinstance_003_partial_under_90(self):
    ...
    def test_br_habitinstance_003_edge_case_150_exact(self):
    ...
    def test_br_habitinstance_003_edge_case_110_exact(self):
    ...
    def test_br_habitinstance_003_edge_case_90_exact(self):
...
class TestBRHabitInstance004:
    ...
    def test_br_habitinstance_004_all_done_maintain_streak(self):
    ...
    def test_br_habitinstance_004_all_not_done_break_streak(self):
...
class TestBRHabitInstance005:
    ...
    def test_br_habitinstance_005_pending_under_48h(self):
    ...
    def test_br_habitinstance_005_pending_over_48h(self):
    ...
    def test_br_habitinstance_005_only_pending_checked(self):
...
class TestBRHabitInstance006:
    ...
    def test_br_habitinstance_006_excessive_triggers_analysis(self):
    ...
    def test_br_habitinstance_006_overdone_triggers_analysis(self):
    ...
    def test_br_habitinstance_006_full_no_analysis(self):
    ...
    def test_br_habitinstance_006_partial_no_analysis(self):
