...
- Avaliação arquitetural sob SRP/SOLID de abril/2026, v1.1.0 com errata sobre TaskService (documento-mãe que propôs este ADR; mantido em `docs/wiki/assessments/` por ter natureza de diagnóstico temporal)
